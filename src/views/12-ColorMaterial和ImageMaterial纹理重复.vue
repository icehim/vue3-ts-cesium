  ...
  dataSource.entities.add({
    ...
    polygon: {
      hierarchy: Cartesian3.fromDegreesArray([
        ...
        105.053011, 41.003906, 105.728954, 40.998429, 107.919731, 41.003906, 109.04798, 40.998429,
        110.047063, 40.998429, 111.047063, 42.000709, 111.047063, 44.476286, 111.05254, 45.002073,
...
onMounted(async () => {
  ...
  // 注册鼠标点击事件
  registerMouseEvent()
  // ColorMaterial和ImageMaterial 纹理重复。
  addArea()
})
</script>
