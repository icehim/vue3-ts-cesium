...
// 天空盒子
const skyBox = () => {
  viewerRef.value!.scene.skyBox = new SkyBox({
    sources: {
      positiveX: './src/assets/images/sky/1.jpg',
      negativeX: './src/assets/images/sky/2.jpg',
      positiveY: './src/assets/images/sky/3.jpg',
      negativeY: './src/assets/images/sky/4.jpg',
      positiveZ: './src/assets/images/sky/6.jpg',
      negativeZ: './src/assets/images/sky/5.jpg'
    }
  })
}
