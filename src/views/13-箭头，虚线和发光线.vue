...
const addLine = () => {
  ...
  dataSource.entities.add({
    ...
    name: 'boderLine',
    polyline: {
      positions: Cartesian3.fromDegreesArray([88, 39, 109, 39]),
      width: 20,
  ...
  dataSource.entities.add({
    ...
    name: 'polylineDash',
    polyline: {
      positions: Cartesian3.fromDegreesArray([88, 35, 109, 35]),
      width: 20,
  ...
  dataSource.entities.add({
    ...
    name: 'polylineGLow',
    polyline: {
      positions: Cartesian3.fromDegreesArray([88, 32, 109, 32]),
      width: 20,
